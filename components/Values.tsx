...
const values = [
  'I will never frame content in a way that misleads your audience',
  'Sources are always credited and copyright rules are followegit statusd without shortcuts',
